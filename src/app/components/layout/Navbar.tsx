      ...
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-28" style={{ height: "var(--nav-h)" }}>
        <nav className="flex h-full items-center justify-between rounded-full bg-gradient-to-r from-[#FFFAF6] to-[#FFE7CC] px-4 sm:px-6 ring-1 ring-black/5">
          ...
          <div className="hidden md:flex items-center gap-3">
            {user ? <AuthedButtons/> : <GuestButtons/>}
          </div>
          ...
          >
            {open ? (
              <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden><path d="M6 6l12 12M18 6L6 18" stroke="black" strokeWidth="2" strokeLinecap="round"/></svg>
            ) : (
              <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden><path d="M4 7h16M4 12h16M4 17h16" stroke="black" strokeWidth="2" strokeLinecap="round"/></svg>
            )}
          </button>
        </nav>
      </div>
